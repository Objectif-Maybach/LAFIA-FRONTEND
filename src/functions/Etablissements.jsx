...
export const GetEtablissementById = async (etablissementId) => {
  try {
    const response = await axios.get(`${Api_Url}establishments/${etablissementId}/`);
    return response.data;
  } catch (error) {
...
export const AddEtablissement = async (etablissementData) => {
  try {
    const response = await axios.post(`${Api_Url}establishments/`,  etablissementData, {
        headers: {
...
export const UpdateEtablissement = async (etablissementId, etablissementData) => {
  try {
    const response = await axios.put(`${Api_Url}establishments/${etablissementId}/`, etablissementData);
    return response.data;
  } catch (error) {
...
export const DeleteEtablissement = async (etablissementId) => {
  try {
    const response = await axios.delete(`${Api_Url}establishments/${etablissementId}/`);
    return response.data;
  } catch (error) {
